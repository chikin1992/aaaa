...
<div id="contentbox">
	<div id="content">
		...
		<form method="POST">
		<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Old Pass   &nbsp;&nbsp;: <input type="password" name="old" required>
		<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; New Pass :  &nbsp;<input type="password" name="new" required>
		
		<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" name="changeBtn" value="  Change  "> &nbsp;&nbsp; <a href="myprofile.php"><input type="button" name="cancelBtn" value="  Cancel  "></a>
		</form>
		...
		<?php
			if(isset($_POST["changeBtn"]))
			{
				...
				if($old!=$kl["pass"])
				{
					?><script>window.alert("Old Password Is Not Match.");</script><?php
				}
				else
				{
					mysql_query("update user set pass='$new' where uid='$uis'");
					?><script>window.alert("Password Changed."); window.location.href = "myprofile.php";</script><?php
				}
			}
		?>
	</div>

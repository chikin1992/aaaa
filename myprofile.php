...
<div id="contentbox">
	<div id="content">
		...
		<?php
			$uis = $_SESSION["uid"];
			$zq = mysql_query("select * from user where uid='$uis'");
			$kl = mysql_fetch_assoc($zq);
			
		?>
		
		<form method="POST">
		<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Username : <?php echo $kl["user"];?>
		<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Password : <?php echo "***********";?> <a href="change.php" style="text-decoration:none;">(Change Password)</a>
		<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Email &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $kl["email"];?>
		<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $kl["name"];?>
		<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<br />
		<br />
		<input type="submit" name="can" value="  My Calendar  ">
		</form>
		
		<?php
			if(isset($_POST["can"]))
			{
				?><script> window.location.href = "calendar/index.php";</script><?php
			}
			...
			if(isset($_POST["registerBtn"]))
			{
				...
				mysql_query("insert into user (user,pass,email,name) values ('$user','$pass','$email','$name')");
				?><script>window.alert("Account Successfully Created."); window.location.href = "index.php";</script><?php
			}
		?>
	</div>
    <div id="news">

...
<div id="contentbox">
	<div id="content">
		...
		<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Message :  &nbsp;<textarea name="msg" required></textarea>
		
		<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" name="changeBtn" value="  Submit  "> &nbsp;&nbsp;
		</form>
...
";
				...
				?><script>window.alert("Feed Back Is Sent !"); window.location.href = "index.php";</script><?php	
